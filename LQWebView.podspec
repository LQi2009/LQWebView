...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  对WKWebView 的封装，继承自UIView，封装了一些方法，方便使用！
                   DESC
  ...
  # Or just: s.author    = "LiuQiqiang"
  # s.authors            = { "LiuQiqiang" => "lqq200912408@163.com" }
  # s.social_media_url   = "http://twitter.com/LiuQiqiang"
